...
var jsPanel = {
  ...
  icons: {
    close:     "<div style='pointer-events: none; min-width:32px; min-height:18px'/></div>",
    maximize:  "<div style='pointer-events: none; min-width:32px; min-height:18px'/></div>",
    normalize: "<div style='pointer-events: none; min-width:32px; min-height:18px'/></div>",
    minimize:  "<div style='pointer-events: none; min-width:32px; min-height:18px'/></div>",
    smallify:  "<div style='pointer-events: none; min-width:32px; min-height:18px'/></div>"
  },
  idCounter: 0,
  isIE: function () {
  ...
  create: function create() {
    ...
    self.setIconfont = function (font) {
      ...
      if (font) {
        ...
        panel.querySelectorAll('.jsPanel-controlbar .jsPanel-btn').forEach(function (item) {
          return jsPanel.emptyNode(item).innerHTML = '<span></span>';
        });
