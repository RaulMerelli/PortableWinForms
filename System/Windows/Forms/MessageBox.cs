...
namespace System.Windows.Forms
{
    public class MessageBox
    {
        ...
        async static void launchWindow(string htmlContent, JsonUtils.Properties.Properties properties)
        {
            string propertiesSerialized = JsonUtils.JsonHelper.Serialize(properties);
