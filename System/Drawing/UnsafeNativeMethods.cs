...
namespace System.Drawing
{
    ...
    internal class UnsafeNativeMethods
    {
        ...
        {
            return System.Windows.Forms.UnsafeNativeMethods.GetSystemDefaultLCID();
        }

        internal static bool SystemParametersInfo(int sPI_GETNONCLIENTMETRICS, int cbSize, NativeMethods.NONCLIENTMETRICS data, int v)
        {
            // dummy
            return false;
        }
